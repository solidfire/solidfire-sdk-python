...
def test_get_hardware_info_v9_1():
    ...
    result = ef.get_hardware_info()
    assert type(result.hardware_info.origin) is dict, "Died on .hardware_info.origin"
    assert result.hardware_info.system_memory.total == 269981622272, "Died on +.hardware_info.system_memory.total"
    assert result.hardware_info.system_memory.free == 216479330304, "Died on +.hardware_info.system_memory.free"
    assert result.hardware_info.system_memory.used == 53502291968, "Died on +.hardware_info.system_memory.used"
    assert type(result.hardware_info.network) is dict, "Died on .hardware_info.network"
    assert type(result.hardware_info.nvram) is dict, "Died on .hardware_info.nvram"
    assert type(result.hardware_info.bus) is dict, "Died on .hardware_info.bus"
    assert type(result.hardware_info.storage) is dict, "Died on .hardware_info.storage"
    assert result.hardware_info.hardware_config is None, "Died on .hardware_info.hardware_config"
    assert type(result.hardware_info.system) is dict, "Died on .hardware_info.system"
    assert result.hardware_info.drive_hardware[9].security_locked == False, "Died on +.hardware_info.drive_hardware[9].security_locked"
    assert result.hardware_info.drive_hardware[9].path == """/dev/sdj""", "Died on +.hardware_info.drive_hardware[9].path"
    assert result.hardware_info.drive_hardware[9].serial == """A0042195""", "Died on +.hardware_info.drive_hardware[9].serial"
    assert result.hardware_info.drive_hardware[9].size == 960197124096, "Died on +.hardware_info.drive_hardware[9].size"
    assert result.hardware_info.drive_hardware[9].slot == 9, "Died on +.hardware_info.drive_hardware[9].slot"
    assert result.hardware_info.drive_hardware[9].uuid == UUID("97e3f7a6-9a7a-05c1-ff4c-ebe017783ec6"), "Died on .hardware_info.drive_hardware[9].uuid"
    assert result.hardware_info.drive_hardware[9].dev_path == """/dev/slot9""", "Died on +.hardware_info.drive_hardware[9].dev_path"
    assert result.hardware_info.drive_hardware[9].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[9].version"
    assert result.hardware_info.drive_hardware[9].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[9].life_remaining_percent"
    assert result.hardware_info.drive_hardware[9].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[9].drive_type"
    assert result.hardware_info.drive_hardware[9].security_supported == True, "Died on +.hardware_info.drive_hardware[9].security_supported"
    assert result.hardware_info.drive_hardware[9].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[9].product"
    assert result.hardware_info.drive_hardware[9].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[9].vendor"
    assert result.hardware_info.drive_hardware[9].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[9].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[9].security_enabled == False, "Died on +.hardware_info.drive_hardware[9].security_enabled"
    assert result.hardware_info.drive_hardware[9].security_frozen == False, "Died on +.hardware_info.drive_hardware[9].security_frozen"
    assert result.hardware_info.drive_hardware[9].connected == True, "Died on +.hardware_info.drive_hardware[9].connected"
    assert result.hardware_info.drive_hardware[9].canonical_name == """sdj""", "Died on +.hardware_info.drive_hardware[9].canonical_name"
    assert result.hardware_info.drive_hardware[9].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[9].reallocated_sectors"
    assert result.hardware_info.drive_hardware[9].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[9].scsi_state"
    assert result.hardware_info.drive_hardware[9].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A0042195""", "Died on +.hardware_info.drive_hardware[9].scsi_compat_id"
    assert result.hardware_info.drive_hardware[9].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[9].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[9].name == """scsi-SATA_SDLFNCAR-960G-1_A0042195""", "Died on +.hardware_info.drive_hardware[9].name"
    assert result.hardware_info.drive_hardware[9].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[9].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[9].dev == 2192, "Died on +.hardware_info.drive_hardware[9].dev"
    assert result.hardware_info.drive_hardware[9].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[9].security_at_maximum"
    assert result.hardware_info.drive_hardware[9].path_link == """/dev/slot9""", "Died on +.hardware_info.drive_hardware[9].path_link"
    assert result.hardware_info.drive_hardware[9].power_on_hours == 1360, "Died on +.hardware_info.drive_hardware[9].power_on_hours"
    assert result.hardware_info.drive_hardware[8].security_locked == False, "Died on +.hardware_info.drive_hardware[8].security_locked"
    assert result.hardware_info.drive_hardware[8].path == """/dev/sdi""", "Died on +.hardware_info.drive_hardware[8].path"
    assert result.hardware_info.drive_hardware[8].serial == """A00422DB""", "Died on +.hardware_info.drive_hardware[8].serial"
    assert result.hardware_info.drive_hardware[8].size == 960197124096, "Died on +.hardware_info.drive_hardware[8].size"
    assert result.hardware_info.drive_hardware[8].slot == 8, "Died on +.hardware_info.drive_hardware[8].slot"
    assert result.hardware_info.drive_hardware[8].uuid == UUID("872a8610-f7dc-c07c-e181-e5b27f49dc51"), "Died on .hardware_info.drive_hardware[8].uuid"
    assert result.hardware_info.drive_hardware[8].dev_path == """/dev/slot8""", "Died on +.hardware_info.drive_hardware[8].dev_path"
    assert result.hardware_info.drive_hardware[8].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[8].version"
    assert result.hardware_info.drive_hardware[8].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[8].life_remaining_percent"
    assert result.hardware_info.drive_hardware[8].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[8].drive_type"
    assert result.hardware_info.drive_hardware[8].security_supported == True, "Died on +.hardware_info.drive_hardware[8].security_supported"
    assert result.hardware_info.drive_hardware[8].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[8].product"
    assert result.hardware_info.drive_hardware[8].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[8].vendor"
    assert result.hardware_info.drive_hardware[8].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[8].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[8].security_enabled == False, "Died on +.hardware_info.drive_hardware[8].security_enabled"
    assert result.hardware_info.drive_hardware[8].security_frozen == False, "Died on +.hardware_info.drive_hardware[8].security_frozen"
    assert result.hardware_info.drive_hardware[8].connected == True, "Died on +.hardware_info.drive_hardware[8].connected"
    assert result.hardware_info.drive_hardware[8].canonical_name == """sdi""", "Died on +.hardware_info.drive_hardware[8].canonical_name"
    assert result.hardware_info.drive_hardware[8].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[8].reallocated_sectors"
    assert result.hardware_info.drive_hardware[8].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[8].scsi_state"
    assert result.hardware_info.drive_hardware[8].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A00422DB""", "Died on +.hardware_info.drive_hardware[8].scsi_compat_id"
    assert result.hardware_info.drive_hardware[8].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[8].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[8].name == """scsi-SATA_SDLFNCAR-960G-1_A00422DB""", "Died on +.hardware_info.drive_hardware[8].name"
    assert result.hardware_info.drive_hardware[8].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[8].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[8].dev == 2176, "Died on +.hardware_info.drive_hardware[8].dev"
    assert result.hardware_info.drive_hardware[8].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[8].security_at_maximum"
    assert result.hardware_info.drive_hardware[8].path_link == """/dev/slot8""", "Died on +.hardware_info.drive_hardware[8].path_link"
    assert result.hardware_info.drive_hardware[8].power_on_hours == 1359, "Died on +.hardware_info.drive_hardware[8].power_on_hours"
    assert result.hardware_info.drive_hardware[7].security_locked == False, "Died on +.hardware_info.drive_hardware[7].security_locked"
    assert result.hardware_info.drive_hardware[7].path == """/dev/sdh""", "Died on +.hardware_info.drive_hardware[7].path"
    assert result.hardware_info.drive_hardware[7].serial == """A0041F78""", "Died on +.hardware_info.drive_hardware[7].serial"
    assert result.hardware_info.drive_hardware[7].size == 960197124096, "Died on +.hardware_info.drive_hardware[7].size"
    assert result.hardware_info.drive_hardware[7].slot == 7, "Died on +.hardware_info.drive_hardware[7].slot"
    assert result.hardware_info.drive_hardware[7].uuid == UUID("d0919cb3-bd2a-10e5-1ac6-9b13d7baae5d"), "Died on .hardware_info.drive_hardware[7].uuid"
    assert result.hardware_info.drive_hardware[7].dev_path == """/dev/slot7""", "Died on +.hardware_info.drive_hardware[7].dev_path"
    assert result.hardware_info.drive_hardware[7].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[7].version"
    assert result.hardware_info.drive_hardware[7].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[7].life_remaining_percent"
    assert result.hardware_info.drive_hardware[7].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[7].drive_type"
    assert result.hardware_info.drive_hardware[7].security_supported == True, "Died on +.hardware_info.drive_hardware[7].security_supported"
    assert result.hardware_info.drive_hardware[7].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[7].product"
    assert result.hardware_info.drive_hardware[7].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[7].vendor"
    assert result.hardware_info.drive_hardware[7].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[7].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[7].security_enabled == False, "Died on +.hardware_info.drive_hardware[7].security_enabled"
    assert result.hardware_info.drive_hardware[7].security_frozen == False, "Died on +.hardware_info.drive_hardware[7].security_frozen"
    assert result.hardware_info.drive_hardware[7].connected == True, "Died on +.hardware_info.drive_hardware[7].connected"
    assert result.hardware_info.drive_hardware[7].canonical_name == """sdh""", "Died on +.hardware_info.drive_hardware[7].canonical_name"
    assert result.hardware_info.drive_hardware[7].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[7].reallocated_sectors"
    assert result.hardware_info.drive_hardware[7].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[7].scsi_state"
    assert result.hardware_info.drive_hardware[7].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A0041F78""", "Died on +.hardware_info.drive_hardware[7].scsi_compat_id"
    assert result.hardware_info.drive_hardware[7].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[7].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[7].name == """scsi-SATA_SDLFNCAR-960G-1_A0041F78""", "Died on +.hardware_info.drive_hardware[7].name"
    assert result.hardware_info.drive_hardware[7].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[7].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[7].dev == 2160, "Died on +.hardware_info.drive_hardware[7].dev"
    assert result.hardware_info.drive_hardware[7].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[7].security_at_maximum"
    assert result.hardware_info.drive_hardware[7].path_link == """/dev/slot7""", "Died on +.hardware_info.drive_hardware[7].path_link"
    assert result.hardware_info.drive_hardware[7].power_on_hours == 1360, "Died on +.hardware_info.drive_hardware[7].power_on_hours"
    assert result.hardware_info.drive_hardware[6].security_locked == False, "Died on +.hardware_info.drive_hardware[6].security_locked"
    assert result.hardware_info.drive_hardware[6].path == """/dev/sdg""", "Died on +.hardware_info.drive_hardware[6].path"
    assert result.hardware_info.drive_hardware[6].serial == """A0042245""", "Died on +.hardware_info.drive_hardware[6].serial"
    assert result.hardware_info.drive_hardware[6].size == 960197124096, "Died on +.hardware_info.drive_hardware[6].size"
    assert result.hardware_info.drive_hardware[6].slot == 6, "Died on +.hardware_info.drive_hardware[6].slot"
    assert result.hardware_info.drive_hardware[6].uuid == UUID("142a1090-4f4c-e0a9-28a7-76f9f5735c3d"), "Died on .hardware_info.drive_hardware[6].uuid"
    assert result.hardware_info.drive_hardware[6].dev_path == """/dev/slot6""", "Died on +.hardware_info.drive_hardware[6].dev_path"
    assert result.hardware_info.drive_hardware[6].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[6].version"
    assert result.hardware_info.drive_hardware[6].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[6].life_remaining_percent"
    assert result.hardware_info.drive_hardware[6].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[6].drive_type"
    assert result.hardware_info.drive_hardware[6].security_supported == True, "Died on +.hardware_info.drive_hardware[6].security_supported"
    assert result.hardware_info.drive_hardware[6].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[6].product"
    assert result.hardware_info.drive_hardware[6].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[6].vendor"
    assert result.hardware_info.drive_hardware[6].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[6].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[6].security_enabled == False, "Died on +.hardware_info.drive_hardware[6].security_enabled"
    assert result.hardware_info.drive_hardware[6].security_frozen == False, "Died on +.hardware_info.drive_hardware[6].security_frozen"
    assert result.hardware_info.drive_hardware[6].connected == True, "Died on +.hardware_info.drive_hardware[6].connected"
    assert result.hardware_info.drive_hardware[6].canonical_name == """sdg""", "Died on +.hardware_info.drive_hardware[6].canonical_name"
    assert result.hardware_info.drive_hardware[6].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[6].reallocated_sectors"
    assert result.hardware_info.drive_hardware[6].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[6].scsi_state"
    assert result.hardware_info.drive_hardware[6].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A0042245""", "Died on +.hardware_info.drive_hardware[6].scsi_compat_id"
    assert result.hardware_info.drive_hardware[6].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[6].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[6].name == """scsi-SATA_SDLFNCAR-960G-1_A0042245""", "Died on +.hardware_info.drive_hardware[6].name"
    assert result.hardware_info.drive_hardware[6].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[6].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[6].dev == 2144, "Died on +.hardware_info.drive_hardware[6].dev"
    assert result.hardware_info.drive_hardware[6].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[6].security_at_maximum"
    assert result.hardware_info.drive_hardware[6].path_link == """/dev/slot6""", "Died on +.hardware_info.drive_hardware[6].path_link"
    assert result.hardware_info.drive_hardware[6].power_on_hours == 1360, "Died on +.hardware_info.drive_hardware[6].power_on_hours"
    assert result.hardware_info.drive_hardware[5].security_locked == False, "Died on +.hardware_info.drive_hardware[5].security_locked"
    assert result.hardware_info.drive_hardware[5].path == """/dev/sdf""", "Died on +.hardware_info.drive_hardware[5].path"
    assert result.hardware_info.drive_hardware[5].serial == """A004214D""", "Died on +.hardware_info.drive_hardware[5].serial"
    assert result.hardware_info.drive_hardware[5].size == 960197124096, "Died on +.hardware_info.drive_hardware[5].size"
    assert result.hardware_info.drive_hardware[5].slot == 5, "Died on +.hardware_info.drive_hardware[5].slot"
    assert result.hardware_info.drive_hardware[5].uuid == UUID("f09d575a-8b1c-cd29-95e9-6a059f090f40"), "Died on .hardware_info.drive_hardware[5].uuid"
    assert result.hardware_info.drive_hardware[5].dev_path == """/dev/slot5""", "Died on +.hardware_info.drive_hardware[5].dev_path"
    assert result.hardware_info.drive_hardware[5].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[5].version"
    assert result.hardware_info.drive_hardware[5].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[5].life_remaining_percent"
    assert result.hardware_info.drive_hardware[5].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[5].drive_type"
    assert result.hardware_info.drive_hardware[5].security_supported == True, "Died on +.hardware_info.drive_hardware[5].security_supported"
    assert result.hardware_info.drive_hardware[5].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[5].product"
    assert result.hardware_info.drive_hardware[5].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[5].vendor"
    assert result.hardware_info.drive_hardware[5].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[5].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[5].security_enabled == False, "Died on +.hardware_info.drive_hardware[5].security_enabled"
    assert result.hardware_info.drive_hardware[5].security_frozen == False, "Died on +.hardware_info.drive_hardware[5].security_frozen"
    assert result.hardware_info.drive_hardware[5].connected == True, "Died on +.hardware_info.drive_hardware[5].connected"
    assert result.hardware_info.drive_hardware[5].canonical_name == """sdf""", "Died on +.hardware_info.drive_hardware[5].canonical_name"
    assert result.hardware_info.drive_hardware[5].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[5].reallocated_sectors"
    assert result.hardware_info.drive_hardware[5].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[5].scsi_state"
    assert result.hardware_info.drive_hardware[5].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A004214D""", "Died on +.hardware_info.drive_hardware[5].scsi_compat_id"
    assert result.hardware_info.drive_hardware[5].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[5].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[5].name == """scsi-SATA_SDLFNCAR-960G-1_A004214D""", "Died on +.hardware_info.drive_hardware[5].name"
    assert result.hardware_info.drive_hardware[5].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[5].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[5].dev == 2128, "Died on +.hardware_info.drive_hardware[5].dev"
    assert result.hardware_info.drive_hardware[5].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[5].security_at_maximum"
    assert result.hardware_info.drive_hardware[5].path_link == """/dev/slot5""", "Died on +.hardware_info.drive_hardware[5].path_link"
    assert result.hardware_info.drive_hardware[5].power_on_hours == 1360, "Died on +.hardware_info.drive_hardware[5].power_on_hours"
    assert result.hardware_info.drive_hardware[4].security_locked == False, "Died on +.hardware_info.drive_hardware[4].security_locked"
    assert result.hardware_info.drive_hardware[4].path == """/dev/sde""", "Died on +.hardware_info.drive_hardware[4].path"
    assert result.hardware_info.drive_hardware[4].serial == """A004220B""", "Died on +.hardware_info.drive_hardware[4].serial"
    assert result.hardware_info.drive_hardware[4].size == 960197124096, "Died on +.hardware_info.drive_hardware[4].size"
    assert result.hardware_info.drive_hardware[4].slot == 4, "Died on +.hardware_info.drive_hardware[4].slot"
    assert result.hardware_info.drive_hardware[4].uuid == UUID("774f2b16-d765-0cb6-ee0d-5e137a48c313"), "Died on .hardware_info.drive_hardware[4].uuid"
    assert result.hardware_info.drive_hardware[4].dev_path == """/dev/slot4""", "Died on +.hardware_info.drive_hardware[4].dev_path"
    assert result.hardware_info.drive_hardware[4].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[4].version"
    assert result.hardware_info.drive_hardware[4].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[4].life_remaining_percent"
    assert result.hardware_info.drive_hardware[4].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[4].drive_type"
    assert result.hardware_info.drive_hardware[4].security_supported == True, "Died on +.hardware_info.drive_hardware[4].security_supported"
    assert result.hardware_info.drive_hardware[4].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[4].product"
    assert result.hardware_info.drive_hardware[4].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[4].vendor"
    assert result.hardware_info.drive_hardware[4].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[4].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[4].security_enabled == False, "Died on +.hardware_info.drive_hardware[4].security_enabled"
    assert result.hardware_info.drive_hardware[4].security_frozen == False, "Died on +.hardware_info.drive_hardware[4].security_frozen"
    assert result.hardware_info.drive_hardware[4].connected == True, "Died on +.hardware_info.drive_hardware[4].connected"
    assert result.hardware_info.drive_hardware[4].canonical_name == """sde""", "Died on +.hardware_info.drive_hardware[4].canonical_name"
    assert result.hardware_info.drive_hardware[4].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[4].reallocated_sectors"
    assert result.hardware_info.drive_hardware[4].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[4].scsi_state"
    assert result.hardware_info.drive_hardware[4].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A004220B""", "Died on +.hardware_info.drive_hardware[4].scsi_compat_id"
    assert result.hardware_info.drive_hardware[4].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[4].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[4].name == """scsi-SATA_SDLFNCAR-960G-1_A004220B""", "Died on +.hardware_info.drive_hardware[4].name"
    assert result.hardware_info.drive_hardware[4].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[4].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[4].dev == 2112, "Died on +.hardware_info.drive_hardware[4].dev"
    assert result.hardware_info.drive_hardware[4].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[4].security_at_maximum"
    assert result.hardware_info.drive_hardware[4].path_link == """/dev/slot4""", "Died on +.hardware_info.drive_hardware[4].path_link"
    assert result.hardware_info.drive_hardware[4].power_on_hours == 1360, "Died on +.hardware_info.drive_hardware[4].power_on_hours"
    assert result.hardware_info.drive_hardware[3].security_locked == False, "Died on +.hardware_info.drive_hardware[3].security_locked"
    assert result.hardware_info.drive_hardware[3].path == """/dev/sdd""", "Died on +.hardware_info.drive_hardware[3].path"
    assert result.hardware_info.drive_hardware[3].serial == """A0042105""", "Died on +.hardware_info.drive_hardware[3].serial"
    assert result.hardware_info.drive_hardware[3].size == 960197124096, "Died on +.hardware_info.drive_hardware[3].size"
    assert result.hardware_info.drive_hardware[3].slot == 3, "Died on +.hardware_info.drive_hardware[3].slot"
    assert result.hardware_info.drive_hardware[3].uuid == UUID("337011b3-3339-7ff6-161a-b9e872acf033"), "Died on .hardware_info.drive_hardware[3].uuid"
    assert result.hardware_info.drive_hardware[3].dev_path == """/dev/slot3""", "Died on +.hardware_info.drive_hardware[3].dev_path"
    assert result.hardware_info.drive_hardware[3].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[3].version"
    assert result.hardware_info.drive_hardware[3].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[3].life_remaining_percent"
    assert result.hardware_info.drive_hardware[3].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[3].drive_type"
    assert result.hardware_info.drive_hardware[3].security_supported == True, "Died on +.hardware_info.drive_hardware[3].security_supported"
    assert result.hardware_info.drive_hardware[3].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[3].product"
    assert result.hardware_info.drive_hardware[3].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[3].vendor"
    assert result.hardware_info.drive_hardware[3].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[3].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[3].security_enabled == False, "Died on +.hardware_info.drive_hardware[3].security_enabled"
    assert result.hardware_info.drive_hardware[3].security_frozen == False, "Died on +.hardware_info.drive_hardware[3].security_frozen"
    assert result.hardware_info.drive_hardware[3].connected == True, "Died on +.hardware_info.drive_hardware[3].connected"
    assert result.hardware_info.drive_hardware[3].canonical_name == """sdd""", "Died on +.hardware_info.drive_hardware[3].canonical_name"
    assert result.hardware_info.drive_hardware[3].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[3].reallocated_sectors"
    assert result.hardware_info.drive_hardware[3].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[3].scsi_state"
    assert result.hardware_info.drive_hardware[3].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A0042105""", "Died on +.hardware_info.drive_hardware[3].scsi_compat_id"
    assert result.hardware_info.drive_hardware[3].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[3].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[3].name == """scsi-SATA_SDLFNCAR-960G-1_A0042105""", "Died on +.hardware_info.drive_hardware[3].name"
    assert result.hardware_info.drive_hardware[3].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[3].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[3].dev == 2096, "Died on +.hardware_info.drive_hardware[3].dev"
    assert result.hardware_info.drive_hardware[3].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[3].security_at_maximum"
    assert result.hardware_info.drive_hardware[3].path_link == """/dev/slot3""", "Died on +.hardware_info.drive_hardware[3].path_link"
    assert result.hardware_info.drive_hardware[3].power_on_hours == 1359, "Died on +.hardware_info.drive_hardware[3].power_on_hours"
    assert result.hardware_info.drive_hardware[2].security_locked == False, "Died on +.hardware_info.drive_hardware[2].security_locked"
    assert result.hardware_info.drive_hardware[2].path == """/dev/sdc""", "Died on +.hardware_info.drive_hardware[2].path"
    assert result.hardware_info.drive_hardware[2].serial == """A0041F64""", "Died on +.hardware_info.drive_hardware[2].serial"
    assert result.hardware_info.drive_hardware[2].size == 960197124096, "Died on +.hardware_info.drive_hardware[2].size"
    assert result.hardware_info.drive_hardware[2].slot == 2, "Died on +.hardware_info.drive_hardware[2].slot"
    assert result.hardware_info.drive_hardware[2].uuid == UUID("58b1771b-af45-636c-94a1-78bf7a96d3cb"), "Died on .hardware_info.drive_hardware[2].uuid"
    assert result.hardware_info.drive_hardware[2].dev_path == """/dev/slot2""", "Died on +.hardware_info.drive_hardware[2].dev_path"
    assert result.hardware_info.drive_hardware[2].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[2].version"
    assert result.hardware_info.drive_hardware[2].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[2].life_remaining_percent"
    assert result.hardware_info.drive_hardware[2].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[2].drive_type"
    assert result.hardware_info.drive_hardware[2].security_supported == True, "Died on +.hardware_info.drive_hardware[2].security_supported"
    assert result.hardware_info.drive_hardware[2].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[2].product"
    assert result.hardware_info.drive_hardware[2].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[2].vendor"
    assert result.hardware_info.drive_hardware[2].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[2].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[2].security_enabled == False, "Died on +.hardware_info.drive_hardware[2].security_enabled"
    assert result.hardware_info.drive_hardware[2].security_frozen == False, "Died on +.hardware_info.drive_hardware[2].security_frozen"
    assert result.hardware_info.drive_hardware[2].connected == True, "Died on +.hardware_info.drive_hardware[2].connected"
    assert result.hardware_info.drive_hardware[2].canonical_name == """sdc""", "Died on +.hardware_info.drive_hardware[2].canonical_name"
    assert result.hardware_info.drive_hardware[2].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[2].reallocated_sectors"
    assert result.hardware_info.drive_hardware[2].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[2].scsi_state"
    assert result.hardware_info.drive_hardware[2].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A0041F64""", "Died on +.hardware_info.drive_hardware[2].scsi_compat_id"
    assert result.hardware_info.drive_hardware[2].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[2].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[2].name == """scsi-SATA_SDLFNCAR-960G-1_A0041F64""", "Died on +.hardware_info.drive_hardware[2].name"
    assert result.hardware_info.drive_hardware[2].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[2].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[2].dev == 2080, "Died on +.hardware_info.drive_hardware[2].dev"
    assert result.hardware_info.drive_hardware[2].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[2].security_at_maximum"
    assert result.hardware_info.drive_hardware[2].path_link == """/dev/slot2""", "Died on +.hardware_info.drive_hardware[2].path_link"
    assert result.hardware_info.drive_hardware[2].power_on_hours == 1360, "Died on +.hardware_info.drive_hardware[2].power_on_hours"
    assert result.hardware_info.drive_hardware[1].security_locked == False, "Died on +.hardware_info.drive_hardware[1].security_locked"
    assert result.hardware_info.drive_hardware[1].path == """/dev/sdb""", "Died on +.hardware_info.drive_hardware[1].path"
    assert result.hardware_info.drive_hardware[1].serial == """A00422F8""", "Died on +.hardware_info.drive_hardware[1].serial"
    assert result.hardware_info.drive_hardware[1].size == 960197124096, "Died on +.hardware_info.drive_hardware[1].size"
    assert result.hardware_info.drive_hardware[1].slot == 1, "Died on +.hardware_info.drive_hardware[1].slot"
    assert result.hardware_info.drive_hardware[1].uuid == UUID("559cfb7f-12ff-a9ec-b238-61e62735d3ab"), "Died on .hardware_info.drive_hardware[1].uuid"
    assert result.hardware_info.drive_hardware[1].dev_path == """/dev/slot1""", "Died on +.hardware_info.drive_hardware[1].dev_path"
    assert result.hardware_info.drive_hardware[1].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[1].version"
    assert result.hardware_info.drive_hardware[1].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[1].life_remaining_percent"
    assert result.hardware_info.drive_hardware[1].drive_type == """Block""", "Died on +.hardware_info.drive_hardware[1].drive_type"
    assert result.hardware_info.drive_hardware[1].security_supported == True, "Died on +.hardware_info.drive_hardware[1].security_supported"
    assert result.hardware_info.drive_hardware[1].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[1].product"
    assert result.hardware_info.drive_hardware[1].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[1].vendor"
    assert result.hardware_info.drive_hardware[1].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[1].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[1].security_enabled == False, "Died on +.hardware_info.drive_hardware[1].security_enabled"
    assert result.hardware_info.drive_hardware[1].security_frozen == False, "Died on +.hardware_info.drive_hardware[1].security_frozen"
    assert result.hardware_info.drive_hardware[1].connected == True, "Died on +.hardware_info.drive_hardware[1].connected"
    assert result.hardware_info.drive_hardware[1].canonical_name == """sdb""", "Died on +.hardware_info.drive_hardware[1].canonical_name"
    assert result.hardware_info.drive_hardware[1].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[1].reallocated_sectors"
    assert result.hardware_info.drive_hardware[1].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[1].scsi_state"
    assert result.hardware_info.drive_hardware[1].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A00422F8""", "Died on +.hardware_info.drive_hardware[1].scsi_compat_id"
    assert result.hardware_info.drive_hardware[1].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[1].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[1].name == """scsi-SATA_SDLFNCAR-960G-1_A00422F8""", "Died on +.hardware_info.drive_hardware[1].name"
    assert result.hardware_info.drive_hardware[1].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[1].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[1].dev == 2064, "Died on +.hardware_info.drive_hardware[1].dev"
    assert result.hardware_info.drive_hardware[1].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[1].security_at_maximum"
    assert result.hardware_info.drive_hardware[1].path_link == """/dev/slot1""", "Died on +.hardware_info.drive_hardware[1].path_link"
    assert result.hardware_info.drive_hardware[1].power_on_hours == 1359, "Died on +.hardware_info.drive_hardware[1].power_on_hours"
    assert result.hardware_info.drive_hardware[0].security_locked == False, "Died on +.hardware_info.drive_hardware[0].security_locked"
    assert result.hardware_info.drive_hardware[0].path == """/dev/sda""", "Died on +.hardware_info.drive_hardware[0].path"
    assert result.hardware_info.drive_hardware[0].serial == """A0042192""", "Died on +.hardware_info.drive_hardware[0].serial"
    assert result.hardware_info.drive_hardware[0].size == 960197124096, "Died on +.hardware_info.drive_hardware[0].size"
    assert result.hardware_info.drive_hardware[0].slot == 0, "Died on +.hardware_info.drive_hardware[0].slot"
    assert result.hardware_info.drive_hardware[0].uuid == UUID("cd3c63b7-e769-4bdc-6453-7454f363a6bf"), "Died on .hardware_info.drive_hardware[0].uuid"
    assert result.hardware_info.drive_hardware[0].dev_path == """/dev/slot0""", "Died on +.hardware_info.drive_hardware[0].dev_path"
    assert result.hardware_info.drive_hardware[0].version == """ZZ39RC93""", "Died on +.hardware_info.drive_hardware[0].version"
    assert result.hardware_info.drive_hardware[0].life_remaining_percent == 100, "Died on +.hardware_info.drive_hardware[0].life_remaining_percent"
    assert result.hardware_info.drive_hardware[0].drive_type == """Slice""", "Died on +.hardware_info.drive_hardware[0].drive_type"
    assert result.hardware_info.drive_hardware[0].security_supported == True, "Died on +.hardware_info.drive_hardware[0].security_supported"
    assert result.hardware_info.drive_hardware[0].product == """SDLFNCAR-960G-1HA2""", "Died on +.hardware_info.drive_hardware[0].product"
    assert result.hardware_info.drive_hardware[0].vendor == """SanDisk""", "Died on +.hardware_info.drive_hardware[0].vendor"
    assert result.hardware_info.drive_hardware[0].lifetime_read_bytes == 26388279066624, "Died on +.hardware_info.drive_hardware[0].lifetime_read_bytes"
    assert result.hardware_info.drive_hardware[0].security_enabled == False, "Died on +.hardware_info.drive_hardware[0].security_enabled"
    assert result.hardware_info.drive_hardware[0].security_frozen == False, "Died on +.hardware_info.drive_hardware[0].security_frozen"
    assert result.hardware_info.drive_hardware[0].connected == True, "Died on +.hardware_info.drive_hardware[0].connected"
    assert result.hardware_info.drive_hardware[0].canonical_name == """sda""", "Died on +.hardware_info.drive_hardware[0].canonical_name"
    assert result.hardware_info.drive_hardware[0].reallocated_sectors == 0, "Died on +.hardware_info.drive_hardware[0].reallocated_sectors"
    assert result.hardware_info.drive_hardware[0].scsi_state == """Running""", "Died on +.hardware_info.drive_hardware[0].scsi_state"
    assert result.hardware_info.drive_hardware[0].scsi_compat_id == """scsi-SATA_SDLFNCAR-960G-1_A0042192""", "Died on +.hardware_info.drive_hardware[0].scsi_compat_id"
    assert result.hardware_info.drive_hardware[0].reserve_capacity_percent == 100, "Died on +.hardware_info.drive_hardware[0].reserve_capacity_percent"
    assert result.hardware_info.drive_hardware[0].name == """scsi-SATA_SDLFNCAR-960G-1_A0042192""", "Died on +.hardware_info.drive_hardware[0].name"
    assert result.hardware_info.drive_hardware[0].lifetime_write_bytes == 8796093022208, "Died on +.hardware_info.drive_hardware[0].lifetime_write_bytes"
    assert result.hardware_info.drive_hardware[0].dev == 2048, "Died on +.hardware_info.drive_hardware[0].dev"
    assert result.hardware_info.drive_hardware[0].security_at_maximum == False, "Died on +.hardware_info.drive_hardware[0].security_at_maximum"
    assert result.hardware_info.drive_hardware[0].path_link == """/dev/slot0""", "Died on +.hardware_info.drive_hardware[0].path_link"
    assert result.hardware_info.drive_hardware[0].power_on_hours == 1360, "Died on +.hardware_info.drive_hardware[0].power_on_hours"
    assert type(result.hardware_info.platform) is dict, "Died on .hardware_info.platform"
    assert result.hardware_info.kernel_crash_dump_state == """EnabledByDefault""", "Died on +.hardware_info.kernel_crash_dump_state"
    assert type(result.hardware_info.memory) is dict, "Died on .hardware_info.memory"
    assert result.hardware_info.serial == """JXBM382""", "Died on +.hardware_info.serial"
    assert type(result.hardware_info.network_interfaces) is dict, "Died on .hardware_info.network_interfaces"
    assert type(result.hardware_info.file_system_usage) is dict, "Died on .hardware_info.file_system_usage"
    assert result.hardware_info.uuid == UUID("4C4C4544-0058-4210-804D-CAC04F333832"), "Died on .hardware_info.uuid"
...
def test_get_hardware_info_v9_2():
    ...
    result = ef.get_hardware_info()
    assert result.hardware_info.origin is None, "Died on .hardware_info.origin"
    assert result.hardware_info.system_memory.total == 33286406144, "Died on +.hardware_info.system_memory.total"
    assert result.hardware_info.system_memory.free == 25261801472, "Died on +.hardware_info.system_memory.free"
    assert result.hardware_info.system_memory.used == 8024604672, "Died on +.hardware_info.system_memory.used"
    assert type(result.hardware_info.network) is dict, "Died on .hardware_info.network"
    assert type(result.hardware_info.nvram) is dict, "Died on .hardware_info.nvram"
    assert type(result.hardware_info.bus) is dict, "Died on .hardware_info.bus"
    assert result.hardware_info.fibre_channel_ports[3].wwnn == """5f:47:ac:c8:8d:08:96:00""", "Died on +.hardware_info.fibre_channel_ports[3].wwnn"
    assert result.hardware_info.fibre_channel_ports[3].switch_wwn == """20:01:8c:60:4f:f1:55:91""", "Died on +.hardware_info.fibre_channel_ports[3].switch_wwn"
    assert result.hardware_info.fibre_channel_ports[3].firmware == """8.02.03 (d0d5)""", "Died on +.hardware_info.fibre_channel_ports[3].firmware"
    assert result.hardware_info.fibre_channel_ports[3].state == """Online""", "Died on +.hardware_info.fibre_channel_ports[3].state"
    assert result.hardware_info.fibre_channel_ports[3].pci_slot == 2, "Died on +.hardware_info.fibre_channel_ports[3].pci_slot"
    assert result.hardware_info.fibre_channel_ports[3].n_port_id == """0x8d0300""", "Died on +.hardware_info.fibre_channel_ports[3].n_port_id"
    assert result.hardware_info.fibre_channel_ports[3].wwpn == """5f:47:ac:c0:8d:08:96:01""", "Died on +.hardware_info.fibre_channel_ports[3].wwpn"
    assert result.hardware_info.fibre_channel_ports[3].model == """QLE2672""", "Died on +.hardware_info.fibre_channel_ports[3].model"
    assert result.hardware_info.fibre_channel_ports[3].speed == """16 Gbit""", "Died on +.hardware_info.fibre_channel_ports[3].speed"
    assert result.hardware_info.fibre_channel_ports[3].hba_port == 2, "Died on +.hardware_info.fibre_channel_ports[3].hba_port"
    assert result.hardware_info.fibre_channel_ports[3].serial == """BFE1435K26220""", "Died on +.hardware_info.fibre_channel_ports[3].serial"
    assert result.hardware_info.fibre_channel_ports[2].wwnn == """5f:47:ac:c8:8d:08:96:00""", "Died on +.hardware_info.fibre_channel_ports[2].wwnn"
    assert result.hardware_info.fibre_channel_ports[2].switch_wwn == """20:01:8c:60:4f:f1:5c:61""", "Died on +.hardware_info.fibre_channel_ports[2].switch_wwn"
    assert result.hardware_info.fibre_channel_ports[2].firmware == """8.02.03 (d0d5)""", "Died on +.hardware_info.fibre_channel_ports[2].firmware"
    assert result.hardware_info.fibre_channel_ports[2].state == """Online""", "Died on +.hardware_info.fibre_channel_ports[2].state"
    assert result.hardware_info.fibre_channel_ports[2].pci_slot == 2, "Died on +.hardware_info.fibre_channel_ports[2].pci_slot"
    assert result.hardware_info.fibre_channel_ports[2].n_port_id == """0x6d0500""", "Died on +.hardware_info.fibre_channel_ports[2].n_port_id"
    assert result.hardware_info.fibre_channel_ports[2].wwpn == """5f:47:ac:c0:8d:08:96:00""", "Died on +.hardware_info.fibre_channel_ports[2].wwpn"
    assert result.hardware_info.fibre_channel_ports[2].model == """QLE2672""", "Died on +.hardware_info.fibre_channel_ports[2].model"
    assert result.hardware_info.fibre_channel_ports[2].speed == """16 Gbit""", "Died on +.hardware_info.fibre_channel_ports[2].speed"
    assert result.hardware_info.fibre_channel_ports[2].hba_port == 1, "Died on +.hardware_info.fibre_channel_ports[2].hba_port"
    assert result.hardware_info.fibre_channel_ports[2].serial == """BFE1435K26220""", "Died on +.hardware_info.fibre_channel_ports[2].serial"
    assert result.hardware_info.fibre_channel_ports[1].wwnn == """5f:47:ac:c8:8d:08:96:00""", "Died on +.hardware_info.fibre_channel_ports[1].wwnn"
    assert result.hardware_info.fibre_channel_ports[1].switch_wwn == """20:01:8c:60:4f:f1:5c:61""", "Died on +.hardware_info.fibre_channel_ports[1].switch_wwn"
    assert result.hardware_info.fibre_channel_ports[1].firmware == """8.02.03 (d0d5)""", "Died on +.hardware_info.fibre_channel_ports[1].firmware"
    assert result.hardware_info.fibre_channel_ports[1].state == """Online""", "Died on +.hardware_info.fibre_channel_ports[1].state"
    assert result.hardware_info.fibre_channel_ports[1].pci_slot == 3, "Died on +.hardware_info.fibre_channel_ports[1].pci_slot"
    assert result.hardware_info.fibre_channel_ports[1].n_port_id == """0x6d0400""", "Died on +.hardware_info.fibre_channel_ports[1].n_port_id"
    assert result.hardware_info.fibre_channel_ports[1].wwpn == """5f:47:ac:c0:8d:08:96:03""", "Died on +.hardware_info.fibre_channel_ports[1].wwpn"
    assert result.hardware_info.fibre_channel_ports[1].model == """QLE2672""", "Died on +.hardware_info.fibre_channel_ports[1].model"
    assert result.hardware_info.fibre_channel_ports[1].speed == """16 Gbit""", "Died on +.hardware_info.fibre_channel_ports[1].speed"
    assert result.hardware_info.fibre_channel_ports[1].hba_port == 2, "Died on +.hardware_info.fibre_channel_ports[1].hba_port"
    assert result.hardware_info.fibre_channel_ports[1].serial == """BFE1435K26421""", "Died on +.hardware_info.fibre_channel_ports[1].serial"
    assert result.hardware_info.fibre_channel_ports[0].wwnn == """5f:47:ac:c8:8d:08:96:00""", "Died on +.hardware_info.fibre_channel_ports[0].wwnn"
    assert result.hardware_info.fibre_channel_ports[0].switch_wwn == """20:01:8c:60:4f:f1:55:91""", "Died on +.hardware_info.fibre_channel_ports[0].switch_wwn"
    assert result.hardware_info.fibre_channel_ports[0].firmware == """8.02.03 (d0d5)""", "Died on +.hardware_info.fibre_channel_ports[0].firmware"
    assert result.hardware_info.fibre_channel_ports[0].state == """Online""", "Died on +.hardware_info.fibre_channel_ports[0].state"
    assert result.hardware_info.fibre_channel_ports[0].pci_slot == 3, "Died on +.hardware_info.fibre_channel_ports[0].pci_slot"
    assert result.hardware_info.fibre_channel_ports[0].n_port_id == """0x8d0200""", "Died on +.hardware_info.fibre_channel_ports[0].n_port_id"
    assert result.hardware_info.fibre_channel_ports[0].wwpn == """5f:47:ac:c0:8d:08:96:02""", "Died on +.hardware_info.fibre_channel_ports[0].wwpn"
    assert result.hardware_info.fibre_channel_ports[0].model == """QLE2672""", "Died on +.hardware_info.fibre_channel_ports[0].model"
    assert result.hardware_info.fibre_channel_ports[0].speed == """16 Gbit""", "Died on +.hardware_info.fibre_channel_ports[0].speed"
    assert result.hardware_info.fibre_channel_ports[0].hba_port == 1, "Died on +.hardware_info.fibre_channel_ports[0].hba_port"
    assert result.hardware_info.fibre_channel_ports[0].serial == """BFE1435K26421""", "Died on +.hardware_info.fibre_channel_ports[0].serial"
    assert type(result.hardware_info.storage) is dict, "Died on .hardware_info.storage"
    assert result.hardware_info.hardware_config is None, "Died on .hardware_info.hardware_config"
    assert type(result.hardware_info.system) is dict, "Died on .hardware_info.system"
    assert type(result.hardware_info.platform) is dict, "Died on .hardware_info.platform"
    assert result.hardware_info.kernel_crash_dump_state == """EnabledByDefault""", "Died on +.hardware_info.kernel_crash_dump_state"
    assert type(result.hardware_info.memory) is dict, "Died on .hardware_info.memory"
    assert result.hardware_info.serial == """B2K8Q22""", "Died on +.hardware_info.serial"
    assert type(result.hardware_info.network_interfaces) is dict, "Died on .hardware_info.network_interfaces"
    assert type(result.hardware_info.file_system_usage) is dict, "Died on .hardware_info.file_system_usage"
    assert result.hardware_info.uuid == UUID("4C4C4544-0032-4B10-8038-C2C04F513232"), "Died on .hardware_info.uuid"
