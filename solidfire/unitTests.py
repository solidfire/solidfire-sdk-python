...
def test_get_ipmi_config_v9_0():
    ...
    force = True # force
    result = ef.get_ipmi_config(chassis_type,force,)
    assert result.nodes[3].node_id == 4, "Died on +.nodes[3].node_id"
    assert result.nodes[3].result.ipmi_config[17].unique_sensor_id == """10.2:0x63""", "Died on +.nodes[3].result.ipmi_config[17].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[17].sensor_name == """PS2""", "Died on +.nodes[3].result.ipmi_config[17].sensor_name"
    assert result.nodes[3].result.ipmi_config[16].unique_sensor_id == """10.1:0x62""", "Died on +.nodes[3].result.ipmi_config[16].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[16].sensor_name == """PS1""", "Died on +.nodes[3].result.ipmi_config[16].sensor_name"
    assert result.nodes[3].result.ipmi_config[15].unique_sensor_id == """7.1:0x4""", "Died on +.nodes[3].result.ipmi_config[15].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[15].sensor_name == """Inlet Temp""", "Died on +.nodes[3].result.ipmi_config[15].sensor_name"
    assert result.nodes[3].result.ipmi_config[14].unique_sensor_id == """7.1:0x1""", "Died on +.nodes[3].result.ipmi_config[14].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[14].sensor_name == """Exhaust Temp""", "Died on +.nodes[3].result.ipmi_config[14].sensor_name"
    assert result.nodes[3].result.ipmi_config[13].unique_sensor_id == """7.1:0x3d""", "Died on +.nodes[3].result.ipmi_config[13].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[13].sensor_name == """Fan7B RPM""", "Died on +.nodes[3].result.ipmi_config[13].sensor_name"
    assert result.nodes[3].result.ipmi_config[12].unique_sensor_id == """7.1:0x3c""", "Died on +.nodes[3].result.ipmi_config[12].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[12].sensor_name == """Fan7A RPM""", "Died on +.nodes[3].result.ipmi_config[12].sensor_name"
    assert result.nodes[3].result.ipmi_config[11].unique_sensor_id == """7.1:0x3b""", "Died on +.nodes[3].result.ipmi_config[11].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[11].sensor_name == """Fan6B RPM""", "Died on +.nodes[3].result.ipmi_config[11].sensor_name"
    assert result.nodes[3].result.ipmi_config[10].unique_sensor_id == """7.1:0x3a""", "Died on +.nodes[3].result.ipmi_config[10].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[10].sensor_name == """Fan6A RPM""", "Died on +.nodes[3].result.ipmi_config[10].sensor_name"
    assert result.nodes[3].result.ipmi_config[9].unique_sensor_id == """7.1:0x39""", "Died on +.nodes[3].result.ipmi_config[9].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[9].sensor_name == """Fan5B RPM""", "Died on +.nodes[3].result.ipmi_config[9].sensor_name"
    assert result.nodes[3].result.ipmi_config[8].unique_sensor_id == """7.1:0x38""", "Died on +.nodes[3].result.ipmi_config[8].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[8].sensor_name == """Fan5A RPM""", "Died on +.nodes[3].result.ipmi_config[8].sensor_name"
    assert result.nodes[3].result.ipmi_config[7].unique_sensor_id == """7.1:0x37""", "Died on +.nodes[3].result.ipmi_config[7].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[7].sensor_name == """Fan4B RPM""", "Died on +.nodes[3].result.ipmi_config[7].sensor_name"
    assert result.nodes[3].result.ipmi_config[6].unique_sensor_id == """7.1:0x36""", "Died on +.nodes[3].result.ipmi_config[6].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[6].sensor_name == """Fan4A RPM""", "Died on +.nodes[3].result.ipmi_config[6].sensor_name"
    assert result.nodes[3].result.ipmi_config[5].unique_sensor_id == """7.1:0x35""", "Died on +.nodes[3].result.ipmi_config[5].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[5].sensor_name == """Fan3B RPM""", "Died on +.nodes[3].result.ipmi_config[5].sensor_name"
    assert result.nodes[3].result.ipmi_config[4].unique_sensor_id == """7.1:0x34""", "Died on +.nodes[3].result.ipmi_config[4].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[4].sensor_name == """Fan3A RPM""", "Died on +.nodes[3].result.ipmi_config[4].sensor_name"
    assert result.nodes[3].result.ipmi_config[3].unique_sensor_id == """7.1:0x33""", "Died on +.nodes[3].result.ipmi_config[3].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[3].sensor_name == """Fan2B RPM""", "Died on +.nodes[3].result.ipmi_config[3].sensor_name"
    assert result.nodes[3].result.ipmi_config[2].unique_sensor_id == """7.1:0x32""", "Died on +.nodes[3].result.ipmi_config[2].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[2].sensor_name == """Fan2A RPM""", "Died on +.nodes[3].result.ipmi_config[2].sensor_name"
    assert result.nodes[3].result.ipmi_config[1].unique_sensor_id == """7.1:0x31""", "Died on +.nodes[3].result.ipmi_config[1].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[1].sensor_name == """Fan1B RPM""", "Died on +.nodes[3].result.ipmi_config[1].sensor_name"
    assert result.nodes[3].result.ipmi_config[0].unique_sensor_id == """7.1:0x30""", "Died on +.nodes[3].result.ipmi_config[0].unique_sensor_id"
    assert result.nodes[3].result.ipmi_config[0].sensor_name == """Fan1A RPM""", "Died on +.nodes[3].result.ipmi_config[0].sensor_name"
    assert result.nodes[2].node_id == 3, "Died on +.nodes[2].node_id"
    assert result.nodes[2].result.ipmi_config[17].unique_sensor_id == """10.2:0x63""", "Died on +.nodes[2].result.ipmi_config[17].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[17].sensor_name == """PS2""", "Died on +.nodes[2].result.ipmi_config[17].sensor_name"
    assert result.nodes[2].result.ipmi_config[16].unique_sensor_id == """10.1:0x62""", "Died on +.nodes[2].result.ipmi_config[16].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[16].sensor_name == """PS1""", "Died on +.nodes[2].result.ipmi_config[16].sensor_name"
    assert result.nodes[2].result.ipmi_config[15].unique_sensor_id == """7.1:0x4""", "Died on +.nodes[2].result.ipmi_config[15].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[15].sensor_name == """Inlet Temp""", "Died on +.nodes[2].result.ipmi_config[15].sensor_name"
    assert result.nodes[2].result.ipmi_config[14].unique_sensor_id == """7.1:0x1""", "Died on +.nodes[2].result.ipmi_config[14].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[14].sensor_name == """Exhaust Temp""", "Died on +.nodes[2].result.ipmi_config[14].sensor_name"
    assert result.nodes[2].result.ipmi_config[13].unique_sensor_id == """7.1:0x3d""", "Died on +.nodes[2].result.ipmi_config[13].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[13].sensor_name == """Fan7B RPM""", "Died on +.nodes[2].result.ipmi_config[13].sensor_name"
    assert result.nodes[2].result.ipmi_config[12].unique_sensor_id == """7.1:0x3c""", "Died on +.nodes[2].result.ipmi_config[12].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[12].sensor_name == """Fan7A RPM""", "Died on +.nodes[2].result.ipmi_config[12].sensor_name"
    assert result.nodes[2].result.ipmi_config[11].unique_sensor_id == """7.1:0x3b""", "Died on +.nodes[2].result.ipmi_config[11].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[11].sensor_name == """Fan6B RPM""", "Died on +.nodes[2].result.ipmi_config[11].sensor_name"
    assert result.nodes[2].result.ipmi_config[10].unique_sensor_id == """7.1:0x3a""", "Died on +.nodes[2].result.ipmi_config[10].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[10].sensor_name == """Fan6A RPM""", "Died on +.nodes[2].result.ipmi_config[10].sensor_name"
    assert result.nodes[2].result.ipmi_config[9].unique_sensor_id == """7.1:0x39""", "Died on +.nodes[2].result.ipmi_config[9].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[9].sensor_name == """Fan5B RPM""", "Died on +.nodes[2].result.ipmi_config[9].sensor_name"
    assert result.nodes[2].result.ipmi_config[8].unique_sensor_id == """7.1:0x38""", "Died on +.nodes[2].result.ipmi_config[8].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[8].sensor_name == """Fan5A RPM""", "Died on +.nodes[2].result.ipmi_config[8].sensor_name"
    assert result.nodes[2].result.ipmi_config[7].unique_sensor_id == """7.1:0x37""", "Died on +.nodes[2].result.ipmi_config[7].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[7].sensor_name == """Fan4B RPM""", "Died on +.nodes[2].result.ipmi_config[7].sensor_name"
    assert result.nodes[2].result.ipmi_config[6].unique_sensor_id == """7.1:0x36""", "Died on +.nodes[2].result.ipmi_config[6].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[6].sensor_name == """Fan4A RPM""", "Died on +.nodes[2].result.ipmi_config[6].sensor_name"
    assert result.nodes[2].result.ipmi_config[5].unique_sensor_id == """7.1:0x35""", "Died on +.nodes[2].result.ipmi_config[5].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[5].sensor_name == """Fan3B RPM""", "Died on +.nodes[2].result.ipmi_config[5].sensor_name"
    assert result.nodes[2].result.ipmi_config[4].unique_sensor_id == """7.1:0x34""", "Died on +.nodes[2].result.ipmi_config[4].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[4].sensor_name == """Fan3A RPM""", "Died on +.nodes[2].result.ipmi_config[4].sensor_name"
    assert result.nodes[2].result.ipmi_config[3].unique_sensor_id == """7.1:0x33""", "Died on +.nodes[2].result.ipmi_config[3].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[3].sensor_name == """Fan2B RPM""", "Died on +.nodes[2].result.ipmi_config[3].sensor_name"
    assert result.nodes[2].result.ipmi_config[2].unique_sensor_id == """7.1:0x32""", "Died on +.nodes[2].result.ipmi_config[2].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[2].sensor_name == """Fan2A RPM""", "Died on +.nodes[2].result.ipmi_config[2].sensor_name"
    assert result.nodes[2].result.ipmi_config[1].unique_sensor_id == """7.1:0x31""", "Died on +.nodes[2].result.ipmi_config[1].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[1].sensor_name == """Fan1B RPM""", "Died on +.nodes[2].result.ipmi_config[1].sensor_name"
    assert result.nodes[2].result.ipmi_config[0].unique_sensor_id == """7.1:0x30""", "Died on +.nodes[2].result.ipmi_config[0].unique_sensor_id"
    assert result.nodes[2].result.ipmi_config[0].sensor_name == """Fan1A RPM""", "Died on +.nodes[2].result.ipmi_config[0].sensor_name"
    assert result.nodes[1].node_id == 2, "Died on +.nodes[1].node_id"
    assert result.nodes[1].result.ipmi_config[17].unique_sensor_id == """10.2:0x63""", "Died on +.nodes[1].result.ipmi_config[17].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[17].sensor_name == """PS2""", "Died on +.nodes[1].result.ipmi_config[17].sensor_name"
    assert result.nodes[1].result.ipmi_config[16].unique_sensor_id == """10.1:0x62""", "Died on +.nodes[1].result.ipmi_config[16].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[16].sensor_name == """PS1""", "Died on +.nodes[1].result.ipmi_config[16].sensor_name"
    assert result.nodes[1].result.ipmi_config[15].unique_sensor_id == """7.1:0x4""", "Died on +.nodes[1].result.ipmi_config[15].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[15].sensor_name == """Inlet Temp""", "Died on +.nodes[1].result.ipmi_config[15].sensor_name"
    assert result.nodes[1].result.ipmi_config[14].unique_sensor_id == """7.1:0x1""", "Died on +.nodes[1].result.ipmi_config[14].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[14].sensor_name == """Exhaust Temp""", "Died on +.nodes[1].result.ipmi_config[14].sensor_name"
    assert result.nodes[1].result.ipmi_config[13].unique_sensor_id == """7.1:0x3d""", "Died on +.nodes[1].result.ipmi_config[13].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[13].sensor_name == """Fan7B RPM""", "Died on +.nodes[1].result.ipmi_config[13].sensor_name"
    assert result.nodes[1].result.ipmi_config[12].unique_sensor_id == """7.1:0x3c""", "Died on +.nodes[1].result.ipmi_config[12].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[12].sensor_name == """Fan7A RPM""", "Died on +.nodes[1].result.ipmi_config[12].sensor_name"
    assert result.nodes[1].result.ipmi_config[11].unique_sensor_id == """7.1:0x3b""", "Died on +.nodes[1].result.ipmi_config[11].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[11].sensor_name == """Fan6B RPM""", "Died on +.nodes[1].result.ipmi_config[11].sensor_name"
    assert result.nodes[1].result.ipmi_config[10].unique_sensor_id == """7.1:0x3a""", "Died on +.nodes[1].result.ipmi_config[10].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[10].sensor_name == """Fan6A RPM""", "Died on +.nodes[1].result.ipmi_config[10].sensor_name"
    assert result.nodes[1].result.ipmi_config[9].unique_sensor_id == """7.1:0x39""", "Died on +.nodes[1].result.ipmi_config[9].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[9].sensor_name == """Fan5B RPM""", "Died on +.nodes[1].result.ipmi_config[9].sensor_name"
    assert result.nodes[1].result.ipmi_config[8].unique_sensor_id == """7.1:0x38""", "Died on +.nodes[1].result.ipmi_config[8].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[8].sensor_name == """Fan5A RPM""", "Died on +.nodes[1].result.ipmi_config[8].sensor_name"
    assert result.nodes[1].result.ipmi_config[7].unique_sensor_id == """7.1:0x37""", "Died on +.nodes[1].result.ipmi_config[7].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[7].sensor_name == """Fan4B RPM""", "Died on +.nodes[1].result.ipmi_config[7].sensor_name"
    assert result.nodes[1].result.ipmi_config[6].unique_sensor_id == """7.1:0x36""", "Died on +.nodes[1].result.ipmi_config[6].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[6].sensor_name == """Fan4A RPM""", "Died on +.nodes[1].result.ipmi_config[6].sensor_name"
    assert result.nodes[1].result.ipmi_config[5].unique_sensor_id == """7.1:0x35""", "Died on +.nodes[1].result.ipmi_config[5].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[5].sensor_name == """Fan3B RPM""", "Died on +.nodes[1].result.ipmi_config[5].sensor_name"
    assert result.nodes[1].result.ipmi_config[4].unique_sensor_id == """7.1:0x34""", "Died on +.nodes[1].result.ipmi_config[4].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[4].sensor_name == """Fan3A RPM""", "Died on +.nodes[1].result.ipmi_config[4].sensor_name"
    assert result.nodes[1].result.ipmi_config[3].unique_sensor_id == """7.1:0x33""", "Died on +.nodes[1].result.ipmi_config[3].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[3].sensor_name == """Fan2B RPM""", "Died on +.nodes[1].result.ipmi_config[3].sensor_name"
    assert result.nodes[1].result.ipmi_config[2].unique_sensor_id == """7.1:0x32""", "Died on +.nodes[1].result.ipmi_config[2].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[2].sensor_name == """Fan2A RPM""", "Died on +.nodes[1].result.ipmi_config[2].sensor_name"
    assert result.nodes[1].result.ipmi_config[1].unique_sensor_id == """7.1:0x31""", "Died on +.nodes[1].result.ipmi_config[1].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[1].sensor_name == """Fan1B RPM""", "Died on +.nodes[1].result.ipmi_config[1].sensor_name"
    assert result.nodes[1].result.ipmi_config[0].unique_sensor_id == """7.1:0x30""", "Died on +.nodes[1].result.ipmi_config[0].unique_sensor_id"
    assert result.nodes[1].result.ipmi_config[0].sensor_name == """Fan1A RPM""", "Died on +.nodes[1].result.ipmi_config[0].sensor_name"
    assert result.nodes[0].node_id == 1, "Died on +.nodes[0].node_id"
    assert result.nodes[0].result.ipmi_config[17].unique_sensor_id == """10.2:0x63""", "Died on +.nodes[0].result.ipmi_config[17].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[17].sensor_name == """PS2""", "Died on +.nodes[0].result.ipmi_config[17].sensor_name"
    assert result.nodes[0].result.ipmi_config[16].unique_sensor_id == """10.1:0x62""", "Died on +.nodes[0].result.ipmi_config[16].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[16].sensor_name == """PS1""", "Died on +.nodes[0].result.ipmi_config[16].sensor_name"
    assert result.nodes[0].result.ipmi_config[15].unique_sensor_id == """7.1:0x4""", "Died on +.nodes[0].result.ipmi_config[15].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[15].sensor_name == """Inlet Temp""", "Died on +.nodes[0].result.ipmi_config[15].sensor_name"
    assert result.nodes[0].result.ipmi_config[14].unique_sensor_id == """7.1:0x1""", "Died on +.nodes[0].result.ipmi_config[14].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[14].sensor_name == """Exhaust Temp""", "Died on +.nodes[0].result.ipmi_config[14].sensor_name"
    assert result.nodes[0].result.ipmi_config[13].unique_sensor_id == """7.1:0x3d""", "Died on +.nodes[0].result.ipmi_config[13].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[13].sensor_name == """Fan7B RPM""", "Died on +.nodes[0].result.ipmi_config[13].sensor_name"
    assert result.nodes[0].result.ipmi_config[12].unique_sensor_id == """7.1:0x3c""", "Died on +.nodes[0].result.ipmi_config[12].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[12].sensor_name == """Fan7A RPM""", "Died on +.nodes[0].result.ipmi_config[12].sensor_name"
    assert result.nodes[0].result.ipmi_config[11].unique_sensor_id == """7.1:0x3b""", "Died on +.nodes[0].result.ipmi_config[11].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[11].sensor_name == """Fan6B RPM""", "Died on +.nodes[0].result.ipmi_config[11].sensor_name"
    assert result.nodes[0].result.ipmi_config[10].unique_sensor_id == """7.1:0x3a""", "Died on +.nodes[0].result.ipmi_config[10].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[10].sensor_name == """Fan6A RPM""", "Died on +.nodes[0].result.ipmi_config[10].sensor_name"
    assert result.nodes[0].result.ipmi_config[9].unique_sensor_id == """7.1:0x39""", "Died on +.nodes[0].result.ipmi_config[9].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[9].sensor_name == """Fan5B RPM""", "Died on +.nodes[0].result.ipmi_config[9].sensor_name"
    assert result.nodes[0].result.ipmi_config[8].unique_sensor_id == """7.1:0x38""", "Died on +.nodes[0].result.ipmi_config[8].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[8].sensor_name == """Fan5A RPM""", "Died on +.nodes[0].result.ipmi_config[8].sensor_name"
    assert result.nodes[0].result.ipmi_config[7].unique_sensor_id == """7.1:0x37""", "Died on +.nodes[0].result.ipmi_config[7].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[7].sensor_name == """Fan4B RPM""", "Died on +.nodes[0].result.ipmi_config[7].sensor_name"
    assert result.nodes[0].result.ipmi_config[6].unique_sensor_id == """7.1:0x36""", "Died on +.nodes[0].result.ipmi_config[6].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[6].sensor_name == """Fan4A RPM""", "Died on +.nodes[0].result.ipmi_config[6].sensor_name"
    assert result.nodes[0].result.ipmi_config[5].unique_sensor_id == """7.1:0x35""", "Died on +.nodes[0].result.ipmi_config[5].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[5].sensor_name == """Fan3B RPM""", "Died on +.nodes[0].result.ipmi_config[5].sensor_name"
    assert result.nodes[0].result.ipmi_config[4].unique_sensor_id == """7.1:0x34""", "Died on +.nodes[0].result.ipmi_config[4].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[4].sensor_name == """Fan3A RPM""", "Died on +.nodes[0].result.ipmi_config[4].sensor_name"
    assert result.nodes[0].result.ipmi_config[3].unique_sensor_id == """7.1:0x33""", "Died on +.nodes[0].result.ipmi_config[3].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[3].sensor_name == """Fan2B RPM""", "Died on +.nodes[0].result.ipmi_config[3].sensor_name"
    assert result.nodes[0].result.ipmi_config[2].unique_sensor_id == """7.1:0x32""", "Died on +.nodes[0].result.ipmi_config[2].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[2].sensor_name == """Fan2A RPM""", "Died on +.nodes[0].result.ipmi_config[2].sensor_name"
    assert result.nodes[0].result.ipmi_config[1].unique_sensor_id == """7.1:0x31""", "Died on +.nodes[0].result.ipmi_config[1].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[1].sensor_name == """Fan1B RPM""", "Died on +.nodes[0].result.ipmi_config[1].sensor_name"
    assert result.nodes[0].result.ipmi_config[0].unique_sensor_id == """7.1:0x30""", "Died on +.nodes[0].result.ipmi_config[0].unique_sensor_id"
    assert result.nodes[0].result.ipmi_config[0].sensor_name == """Fan1A RPM""", "Died on +.nodes[0].result.ipmi_config[0].sensor_name"
