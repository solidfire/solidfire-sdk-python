...
class GetEfficiencyResult(data_model.DataObject):
    ...
    :param compression: (optional) The amount of space being saved by
        compressing data on a single volume. Stated as a ratio where \"1\"
        means data has been stored without being compressed.
    :type compression: float

    :param deduplication: (optional) The amount of space being saved on a
        single volume by not duplicating data. Stated as a ratio.
    :type deduplication: float

    :param thin_provisioning: (optional) The ratio of space used to the amount
...
class GetNtpInfoResult(data_model.DataObject):
    """
    The object returned by the \"get_ntp_info\" API Service call.

    :param broadcastclient: [required] Indicates whether or not the nodes in
        the cluster are listening for broadcast NTP messages. Possible values:
        true false
    ...
    broadcastclient = data_model.property(
        ...
        array=False, optional=False,
        documentation="\
        Indicates whether or not the nodes in the cluster are listening for\
        broadcast NTP messages. Possible values:\
        true\
        false\
        "
    )
...
class ModifyVolumeResult(data_model.DataObject):
    ...
    :param volume: [required] Object containing information about the newly
        modified volume.
    :type volume: Volume
    """
