...
class ListVirtualVolumesRequest(data_model.DataObject):
    """
    :param start_virtual_volume_id:  The ID of the first Virtual Volume to list. This can be useful for paging results. By default, this lists all Virtual Volumes. 
    :type start_virtual_volume_id: UUID
    
    :param limit:  The maximum number of volumes to return from the API. 
    :type limit: int
    
    :param virtual_volume_ids:  List of Virtual Volume IDs to get. 
