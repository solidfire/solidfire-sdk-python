...
class RestartNetworkingResult(data_model.DataObject):
    """
    :param details: [required] 
    :type details: str

    :param duration: [required] The length of time, in seconds, it took to restart services to the node. 
    :type duration: str

    :param result: [required] Results of the restart. 
    :type result: str
    """
    details = data_model.property(
        "details", str,
    ...
    duration = data_model.property(
        "duration", str,
        array=False, optional=False,
        documentation="The length of time, in seconds, it took to restart services to the node.",
        dictionaryType=None
    )
    result = data_model.property(
        "result", str,
        array=False, optional=False,
        documentation="Results of the restart.",
        dictionaryType=None
    )
...
class RestartServicesResult(data_model.DataObject):
    """
    :param details: [required] 
    :type details: str
