...
class VirtualVolumeBitmapResult(data_model.DataObject):
    ...
    :param segment_length: [required] Byte length, adjusted to end on a chunk boundary.
...
class VasaProviderInfo(data_model.DataObject):
    ...
    :param control_port: [required] 
    :type control_port: int
    
    :param vasa_provider_id: [required] 
    :type vasa_provider_id: UUID
...
class VasaProviderInfoResult(data_model.DataObject):
    """
    :param vasa_provider_info: [required] 
    :type vasa_provider_info: VasaProviderInfo
    """
...
class NodeNetworkInterface(data_model.DataObject):
    """
    :param node_id: [required] The ID of the node.
    :type node_id: int
...
class Drive(data_model.DataObject):
    ...
    :param node_id: [required] [&#x27;The node this drive is located.&#x27;, &#x27;If the drive has been physically removed from the node, this is where it was last seen.&#x27;][&#x27;The node this drive is located.&#x27;, &#x27;If the drive has been physically removed from the node, this is where it was last seen.&#x27;]
    :type node_id: int
...
class Service(data_model.DataObject):
    ...
    :param associated_bv:  [&quot;This service&#x27;s associated bulk volume service.&quot;, &#x27;This will only be set if the service type is a slice service.&#x27;][&quot;This service&#x27;s associated bulk volume service.&quot;, &#x27;This will only be set if the service type is a slice service.&#x27;]
    :type associated_bv: int
    
    :param associated_ts:  [&quot;This service&#x27;s associated transport service.&quot;, &#x27;This will only be set if the service type is a slice service.&#x27;][&quot;This service&#x27;s associated transport service.&quot;, &#x27;This will only be set if the service type is a slice service.&#x27;]
    :type associated_ts: int
    
    :param associated_vs:  [&quot;This service&#x27;s associated volume service.&quot;, &#x27;This will only be set if the service type is a slice service.&#x27;][&quot;This service&#x27;s associated volume service.&quot;, &#x27;This will only be set if the service type is a slice service.&#x27;]
    ...
    :param first_time_startup: [required] [&#x27;Has this service started successfully?&#x27;, &#x27;When a new drive is added to the system, the created service will initially have a value of false here.&#x27;, &#x27;After the service has started, this value will be set to true.&#x27;, &#x27;This can be used to check if the service has ever started.&#x27;][&#x27;Has this service started successfully?&#x27;, &#x27;When a new drive is added to the system, the created service will initially have a value of false here.&#x27;, &#x27;After the service has started, this value will be set to true.&#x27;, &#x27;This can be used to check if the service has ever started.&#x27;][&#x27;Has this service started successfully?&#x27;, &#x27;When a new drive is added to the system, the created service will initially have a value of false here.&#x27;, &#x27;After the service has started, this value will be set to true.&#x27;, &#x27;This can be used to check if the service has ever started.&#x27;][&#x27;Has this service started successfully?&#x27;, &#x27;When a new drive is added to the system, the created service will initially have a value of false here.&#x27;, &#x27;After the service has started, this value will be set to true.&#x27;, &#x27;This can be used to check if the service has ever started.&#x27;]
    :type first_time_startup: bool
    
    :param ipc_port: [required] [&#x27;The port used for intra-cluster communication.&#x27;, &#x27;This will be in the 4000-4100 range.&#x27;][&#x27;The port used for intra-cluster communication.&#x27;, &#x27;This will be in the 4000-4100 range.&#x27;]
    :type ipc_port: int
    
    :param iscsi_port: [required] [&#x27;The port used for iSCSI traffic.&#x27;, &#x27;This will only be set if the service type is a transport service.&#x27;][&#x27;The port used for iSCSI traffic.&#x27;, &#x27;This will only be set if the service type is a transport service.&#x27;]
    :type iscsi_port: int
    """
    service_id = data_model.property(
        "serviceID", int,
...
class VirtualVolumeUnbindResult(data_model.DataObject):
    """
    :param unbind_results: [required] 
    :type unbind_results: UnbindResult
    """
...
class UnbindArguments(data_model.DataObject):
    ...
    :param protocol_endpoint_in_band_id: [required] 
    :type protocol_endpoint_in_band_id: str
    
    :param virtual_volume_secondary_id: [required] 
    :type virtual_volume_secondary_id: str
    """
    virtual_volume_id = data_model.property(
        "virtualVolumeID", UUID,
...
class ProtocolEndpointResult(data_model.DataObject):
    """
    :param protocol_endpoint: [required] 
    :type protocol_endpoint: ProtocolEndpoint
    """
    protocol_endpoint = data_model.property(
...
class VirtualVolumeSyncResult(data_model.DataObject):
    ...
    :param virtual_volume_id: [required] virtualVolumeID for the newly created volume.
    :type virtual_volume_id: UUID
    """
    volume_id = data_model.property(
        "volumeID", int,
...
class QueryVirtualVolumeMetadataResult(data_model.DataObject):
    """
    :param matching_virtual_volume_ids: [required] 
    :type matching_virtual_volume_ids: UUID
    """
